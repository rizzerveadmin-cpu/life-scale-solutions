...
import marySpeaking from "@/assets/mary-speaking.jpeg";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "From rural Kenya to global influence — the seven chapters." },
...
const chapters = [
  { n: "01", title: "Early Life In Kenya", body: "A childhood in rural Kenya shaped by limited resources, deep community, and an early belief that opportunity must be built — not waited for." },
  { n: "02", title: "Education Against The Odds", body: "School after school, sacrifice after sacrifice. Education became the lever that would later move organisations, sectors, and lives." },
  { n: "03", title: "Migration To Australia", body: "Arriving with $500 to her name. A new country, no safety net, and the conviction that systems can be rebuilt for those they leave behind." },
  { n: "04", title: "PhD Journey", body: "Single motherhood, full-time work, and doctoral research — pursued in parallel. The discipline that still defines how she leads today." },
  { n: "05", title: "Building Businesses", body: "From practitioner to founder. Designing and scaling services across disability, education, and youth development with commercial rigour." },
  { n: "06", title: "Impact At Scale", body: "4,000+ families. Multi-million dollar service growth. National recognition as a builder of sustainable social outcomes." },
  { n: "07", title: "What's Next", body: "Acquisitions, advisory, investment and platform-level reform — building the next generation of impact businesses." },
];

const chapterImages = [maryStanding, maryPortrait, maryLiving, marySpeaking];
